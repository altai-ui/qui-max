...
function debouncedWatch(source, cb, options = {}) {
  const _a2 = options,
    { debounce = 0 } = _a2,
    watchOptions = __objRest$4(_a2, ['debounce']);
  return watchWithFilter(
    source,
    cb,
    __spreadProps$5(__spreadValues$8({}, watchOptions), {
...
function ignorableWatch(source, cb, options = {}) {
  const _a2 = options,
    { eventFilter = bypassFilter } = _a2,
    watchOptions = __objRest$3(_a2, ['eventFilter']);
...
function pausableWatch(source, cb, options = {}) {
  ...
  const stop = watchWithFilter(
    source,
    cb,
    __spreadProps$2(__spreadValues$4({}, watchOptions), {
      eventFilter
    })
  );
...
function throttledWatch(source, cb, options = {}) {
  const _a2 = options,
    ...
    watchOptions = __objRest$1(_a2, ['throttle', 'trailing', 'leading']);
  return watchWithFilter(
    source,
    cb,
    __spreadProps$1(__spreadValues$3({}, watchOptions), {
    ...
    result[key] = customRef(() => ({
      ...
      set(v) {
        if (Array.isArray(objectRef.value)) {
          ...
          objectRef.value = __spreadProps(
            __spreadValues$2({}, objectRef.value),
            { [key]: v }
          );
        }
      }
...
function watchAtMost(source, cb, options) {
  const _a2 = options,
    { count } = _a2,
    watchOptions = __objRest(_a2, ['count']);
  const current = ref(0);
  const stop = watchWithFilter(
    source,
    (...args) => {
...
function onClickOutside(target, handler, options = {}) {
  ...
  const cleanup = [
    useEventListener(window2, 'click', listener, {
      passive: true,
      capture: true
    }),
    useEventListener(
...
function onKeyDown(key, handler, options = {}) {
  return onKeyStroke(
    key,
    handler,
    __spreadProps$9(__spreadValues$h({}, options), { eventName: 'keydown' })
  );
}
function onKeyPressed(key, handler, options = {}) {
  return onKeyStroke(
    key,
    handler,
    __spreadProps$9(__spreadValues$h({}, options), { eventName: 'keypress' })
  );
}
function onKeyUp(key, handler, options = {}) {
  return onKeyStroke(
    key,
    handler,
    __spreadProps$9(__spreadValues$h({}, options), { eventName: 'keyup' })
  );
}
...
function onLongPress(target, handler, options) {
  ...
  function onDown(ev) {
    ...
    timeout = setTimeout(
      () => handler(ev),
      (_a2 = options == null ? void 0 : options.delay) != null
        ? _a2
        : DEFAULT_DELAY
    );
  }
...
function useCycleList(list, options) {
  const state = shallowRef(
    (options == null ? void 0 : options.initialValue) || list[0]
  );
  const index = computed({
    get() {
      ...
      if (index2 < 0)
        index2 =
          (_a2 = options == null ? void 0 : options.fallbackIndex) != null
            ? _a2
            : 0;
      return index2;
    },
...
function useDark(options = {}) {
  ...
  const mode = useColorMode(
    __spreadProps$8(__spreadValues$e({}, options), {
...
function useRefHistory(source, options = {}) {
  ...
  const manualHistory = useManualRefHistory(
    source,
    __spreadProps$7(__spreadValues$d({}, options), {
...
var __spreadValues$c = (a, b) => {
  ...
  if (__getOwnPropSymbols$e)
    for (var prop of __getOwnPropSymbols$e(b)) {
      if (__propIsEnum$e.call(b, prop)) __defNormalProp$c(a, prop, b[prop]);
    }
  return a;
};
...
function useDebouncedRefHistory(source, options = {}) {
  ...
  const history = useRefHistory(
    source,
    __spreadProps$6(__spreadValues$c({}, options), { eventFilter: filter })
  );
...
function useDisplayMedia(options = {}) {
  ...
  const isSupported = Boolean(
    (_b2 = navigator == null ? void 0 : navigator.mediaDevices) == null
      ? void 0
      : _b2.getDisplayMedia
  );
...
var __spreadValues$b = (a, b) => {
  ...
  if (__getOwnPropSymbols$d)
    for (var prop of __getOwnPropSymbols$d(b)) {
      if (__propIsEnum$d.call(b, prop)) __defNormalProp$b(a, prop, b[prop]);
    }
  return a;
};
...
function useDraggable(target, options = {}) {
  ...
  const position = ref(
    (_b2 = options.initialValue) != null ? _b2 : { x: 0, y: 0 }
  );
...
function useElementVisibility(
  ...
  if (window2)
    tryOnMounted(() =>
      useEventListener(
        (scrollTarget == null ? void 0 : scrollTarget.value) || window2,
        'scroll',
        testBounding,
...
var __spreadValues$9 = (a, b) => {
  for (var prop in b || (b = {}))
    if (__hasOwnProp$a2.call(b, prop)) __defNormalProp$9(a, prop, b[prop]);
  if (__getOwnPropSymbols$a2)
    for (var prop of __getOwnPropSymbols$a2(b)) {
      if (__propIsEnum$a2.call(b, prop)) __defNormalProp$9(a, prop, b[prop]);
    }
  return a;
};
  ...
  function useFactoryFetch(url, ...args) {
    ...
    if (args.length > 0) {
      if (isFetchOptions(args[0])) {
        ...
        fetchOptions = __spreadProps$42(
          __spreadValues$9(__spreadValues$9({}, fetchOptions), args[0]),
          {
            headers: __spreadValues$9(
              __spreadValues$9({}, headersToObject(fetchOptions.headers) || {}),
  ...
  const execute = async (throwOnFailed = false) => {
    ...
    return new Promise((resolve, reject) => {
      ...
      fetch(
        ...
        __spreadProps$42(
          __spreadValues$9(
            __spreadValues$9({}, defaultFetchOptions),
            context.options
          ),
          {
            headers: __spreadValues$9(
...
function useInfiniteScroll(element, onLoadMore, options = {}) {
  ...
  const state = reactive(
    useScroll(
      element,
      __spreadProps$32(__spreadValues$82({}, options), {
  ...
  const share = async (overrideOptions = {}) => {
    if (isSupported) {
      const data = __spreadValues$42(
        __spreadValues$42({}, unref(shareOptions)),
...
function useTextSelection(element) {
  ...
  const onMouseup = () => {
    var _a22;
    const text =
      (_a22 = window.getSelection()) == null ? void 0 : _a22.toString();
    if (text) {
      const rect = getRectFromSelection(window.getSelection());
      state.value = __spreadProps$12(
        __spreadValues$32(__spreadValues$32({}, state.value), rect),
        {
          text
        }
      );
  ...
  const start = () => {
    ...
    diffVector = outputVector.value.map((n, i) => {
      ...
      return (
        ...
        ((_b2 = outputVector.value[i]) != null ? _b2 : 0)
      );
    });
...
function useVModel(props, key, emit, options = {}) {
  ...
  if (!key) {
    if (isVue2) {
      const modelOptions =
        (_c =
          (_b2 = vm == null ? void 0 : vm.proxy) == null
            ? void 0
            : _b2.$options) == null
          ? void 0
          : _c.model;
