  ...
  <span class="badge-shields">
    ...
    <span>
      <img
        ...
        src="https://img.shields.io/npm/types/@qvant/qui-max"
      />
    </span>
    <span>
    ...
    <span>
      <img
        alt="npm bundle size"
        src="https://img.shields.io/bundlephobia/minzip/@qvant/qui-max?color=brightgreen"
      />
    </span>
    <span class="badge-npmversion">
      <a
        href="https://npmjs.org/package/@qvant/qui-max"
        title="View this project on NPM"
      >
        <img
          src="https://img.shields.io/npm/v/@qvant/qui-max.svg"
          alt="NPM version"
        />
      </a>
    </span>
    <span class="badge-npmdownloads">
      ...
      >
        <img
          src="https://img.shields.io/npm/dm/@qvant/qui-max.svg"
          alt="NPM downloads"
        />
      </a>
    </span>
...
- import styles separately to avoid unused cs
